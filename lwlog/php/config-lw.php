...
// Host: Locaweb recomenda não usar o IP que pode mudar e sim usar o nome do DB "tmscte_lwlog.l70dnn0097.mysql.dbaas.com.br"
// define("HOST", "191.252.99.60");
define("HOST", "tmscte_lwlog.l70dnn0097.mysql.dbaas.com.br");
define("PASS", "tmsrnm6485");
define("DB", "tmscte_lwlog");
define("USER", "tmscte_lwlog");

define("PREFIX", 'tmsexpressocloud');
define("PROJECT", 'TMS - Expresso Cloud');
define("VERSION", '2.0');
define("PATH", "/home/sistrom4/public_html/lwlog/");
define("URL", "https://www.sistrom.com.br/lwlog/");
