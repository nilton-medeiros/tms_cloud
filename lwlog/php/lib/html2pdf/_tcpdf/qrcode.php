...
if (!defined('QRCODEDEFS')) {
	...
	// ExtJSException correcting is defined in 4 level as below.

	/**
	 * ExtJSException correction level L : About 7% or less errors can be corrected.
	 */
	define('QR_ECLEVEL_L', 0);

	/**
	 * ExtJSException correction level M : About 15% or less errors can be corrected.
	 */
	define('QR_ECLEVEL_M', 1);

	/**
	 * ExtJSException correction level Q : About 25% or less errors can be corrected.
	 */
	define('QR_ECLEVEL_Q', 2);

	/**
	 * ExtJSException correction level H : About 30% or less errors can be corrected.
	 */
