...
Ext.define('Ext.ux.upload.Basic', {
    ...
    constructor: function(owner, config)
    {
        ...
        Ext.apply(config, {
        	uploadButtonText: 'Iniciar',
			cancelButtonText: 'Cancelar',
			deleteUploadedText: 'Excluir',
			deleteAllText: 'Excluir todos',
			uploadButtonCls: 'icon-upload-2',
			cancelButtonCls: 'icon-cancel-2',
			removeButtonCls: 'icon-minus',
			removeAllButtonCls: 'icon-remove'
        });
        ...
        me.actions = {
            ...
            removeUploaded: Ext.create('Ext.Action', {
                ...
                iconCls: config.removeButtonCls,
                scope: me
            }),
            removeAll: Ext.create('Ext.Action', {
                ...
                iconCls: config.removeAllButtonCls,
                scope: me
            })
        };
